const experiences = [
  ...
  },
  {
    ...
    description: 'Developed user-friendly web interfaces for various clients.',
  ...
  {
    period: '2016 - 2018',
    role: 'Junior Developer at CodeFactory',
    description: 'Assisted in the development of web applications and performed code reviews.',
    company: 'CodeFactory',
    ...
    <div className="container mx-auto px-6 relative z-10">
      ...
      <div className="max-w-3xl mb-16">
       ...
       <p className="text-muted-foreground animate-fade-in animation-delay-200">
          Over the years, I've had the privilege of working with some incredible companies, each contributing to my growth as a developer. Here's a glimpse into my professional journey.
       </p>
      </div>
          ...
          {experiences.map((exp, idx) => (
            ...
            className="relative grid md:grid-cols-2 gap-8 animate-fade-in">
              ...
              <div className={`pl-8 md:pl-0 ${idx % 2 === 0 ? "md:pr-16 md:text-right" : "md:col-start-2 md:pl-16"}`}>
                <div className={`glass p-6 rounded-2xl border border-primary/30 hover:primary/50 transition-all duration-500 `}>
